...
class _AddClientPageState extends State<AddClientPage> {
  ...
  TextEditingController nombre = new TextEditingController(text: '');
  TextEditingController desc = new TextEditingController(text: '');
  TextEditingController tel = new TextEditingController(text: '');
  TextEditingController email = new TextEditingController(text: '');
  TextEditingController ec = new TextEditingController(text: '1');
  ...
  Widget _subtitle(){
    return Container(
      ...
      child: Text(
        'Rellene correctamente los campos para agregar un nuevo cliente.',
      ...
      child: ElevatedButton(
        onPressed: (){
          if(nombre.text.isNotEmpty && desc.text.isNotEmpty && email.text.isNotEmpty && tel.text.isNotEmpty && ec.text.isNotEmpty){
            alertConfirmSave(context, '', 'Confirme que desea guardar un nuevo cliente',nombre.text, desc.text, email.text, tel.text, int.parse(ec.text));
          }else{
